...
expected_logged_ratio_metadata = float(config.get("expected_logged_energy_ratio_step2000_over_step0"))
...
metadata_commit_expected = str(git_commit).startswith("b245295")
metadata_mode_expected = mode == "phase8B_no_forcing_single_mode_decay_dt_half"
...
energy_error_improved_vs_8A = energy_ratio_rel_error < reference_energy_error
enstrophy_error_improved_vs_8A = enstrophy_ratio_rel_error < reference_enstrophy_error

energy_error_ratio_vs_8A = energy_ratio_rel_error / reference_energy_error
enstrophy_error_ratio_vs_8A = enstrophy_ratio_rel_error / reference_enstrophy_error
...
overall_pass = all(
    [
        ...
        enstrophy_energy_relation_ok,
        energy_error_improved_vs_8A,
        enstrophy_error_improved_vs_8A,
    ]
)
...
print(f"Git commit starts with b245295: {pass_fail(metadata_commit_expected)}")
...
print(f"Phase 8B energy ratio rel error:     {energy_ratio_rel_error:.12e}")
print(f"8B / 8A energy error ratio:          {energy_error_ratio_vs_8A:.12e}")
print(f"Energy error improved vs 8A:         {pass_fail(energy_error_improved_vs_8A)}")

print(f"Phase 8A enstrophy ratio rel error:  {reference_enstrophy_error:.12e}")
print(f"Phase 8B enstrophy ratio rel error:  {enstrophy_ratio_rel_error:.12e}")
print(f"8B / 8A enstrophy error ratio:       {enstrophy_error_ratio_vs_8A:.12e}")
print(f"Enstrophy error improved vs 8A:      {pass_fail(enstrophy_error_improved_vs_8A)}")
...
print("\n=== OVERALL RESULT ===")
print(f"Phase 8B half-dt decay audit: {pass_fail(overall_pass)}")
...
summary = {
    ...
    "phase8B_over_phase8A_energy_error_ratio": energy_error_ratio_vs_8A,
    "energy_error_improved_vs_8A": pass_fail(energy_error_improved_vs_8A),
    ...
    "phase8B_over_phase8A_enstrophy_error_ratio": enstrophy_error_ratio_vs_8A,
    "enstrophy_error_improved_vs_8A": pass_fail(enstrophy_error_improved_vs_8A),
...
print("Phase 8B half-dt decay audit complete.")