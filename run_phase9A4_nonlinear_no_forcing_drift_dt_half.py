...
def run_phase9a4_nonlinear_no_forcing_drift_dt_half():
    ...
    config = {
        "mode": "phase9A4_nonlinear_no_forcing_drift_dt_half",
        "Re": re_value,
        "nu": nu,
        "nx": nx,
        "ny": ny,
        ...
        "phase9A3_reference": "experiments/runs/run_2026-07-12_00-38-33",
        "purpose": "half-dt sensitivity test for short nonlinear no-forcing energy and enstrophy drift",
    ...
    print("Starting Phase 9A.4 half-dt nonlinear no-forcing drift test")
    print(f"Re: {re_value}")
    print(f"nu: {nu}")
    ...
    print("Phase 9A.4 half-dt nonlinear no-forcing drift test finished")
    print(f"Status: {status}")
    print(f"Run folder: {run_path}")


if __name__ == "__main__":
    run_phase9a4_nonlinear_no_forcing_drift_dt_half()