...
METHOD_OUT_CSV = Path("PHASE12F_N256_THREE_METHOD_SHORT_FEASIBILITY_AUDIT.csv")
PAIRWISE_OUT_CSV = Path("PHASE12F_N256_THREE_METHOD_SHORT_FEASIBILITY_PAIRWISE.csv")
...
print("Purpose: run short N256 feasibility across fd_centered, pseudo_spectral, and arakawa.")
...
reference_solver = SpectralSolver(
    ...
    ny=N,
    Re=RE,
    run_path=Path("experiments") / "reference" / "phase12F_N256_reference_grid",
    dt=DT,
    steps=STEPS,
)
...
for method in METHODS:
    solvers[method] = SelectableAdvectionSolver(
        ...
        ny=N,
        Re=RE,
        run_path=Path("experiments") / "selectable_diagnostics" / f"phase12F_N256_{method}",
        dt=DT,
        steps=STEPS,
...
print("\n=== OVERALL RESULT ===")
print(f"Phase 12F N256 three-method short feasibility audit: {pass_fail(overall_pass)}")
...
print("\n=== SCIENTIFIC BOUNDARY ===")
print("This is an N256 three-method short feasibility audit only.")
print("This does not prove full N256 final-time-1.0 feasibility.")
...
print("Phase 12F audit complete.")